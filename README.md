...
Thirty-one roadmaps (**v1–v31**, Phases 0–171) have shipped and are merged to `main`, each green on a cleared clean build — 6 unit suites plus the full smoke / fuzz aggregate, **JIT and AOT**, on ubuntu + macOS CI. Current release: **[v0.31.0](https://github.com/kardashevlang/kardashev/releases/latest)**.
