...
Twenty-three roadmaps (**v1–v23**, Phases 0–129) have shipped and are merged to `main`, each green on a cleared clean build — 6 unit suites plus the full smoke / fuzz aggregate, **JIT and AOT**, on ubuntu + macOS CI. Current release: **[v0.23.0](https://github.com/kardashevlang/kardashev/releases/latest)**.
