...
Twenty-eight roadmaps (**v1–v28**, Phases 0–156) have shipped and are merged to `main`, each green on a cleared clean build — 6 unit suites plus the full smoke / fuzz aggregate, **JIT and AOT**, on ubuntu + macOS CI. Current release: **[v0.28.0](https://github.com/kardashevlang/kardashev/releases/latest)**.
