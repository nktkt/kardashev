...
Twenty-five roadmaps (**v1–v25**, Phases 0–140) have shipped and are merged to `main`, each green on a cleared clean build — 6 unit suites plus the full smoke / fuzz aggregate, **JIT and AOT**, on ubuntu + macOS CI. Current release: **[v0.25.0](https://github.com/kardashevlang/kardashev/releases/latest)**.
